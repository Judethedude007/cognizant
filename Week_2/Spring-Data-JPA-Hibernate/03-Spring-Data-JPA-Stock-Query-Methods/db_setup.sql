...
-- Extra Facebook rows for top 3 highest volume query
...
-- Google rows for close greater than 1250
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('GOOGL', '2019-04-18', 1239.18, 1236.37, 1331800);
...
-- Netflix rows for lowest stock query
...
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('NFLX', '2019-09-03', 294.00, 289.29, 4652500);

SELECT * FROM stock ORDER BY st_code, st_date;
